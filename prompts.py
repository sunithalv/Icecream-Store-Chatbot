...
You are an ice cream assistant chatbot. Your expertise is exclusively in providing information and
...
api_url_template = """
Given the following API Documentation for Icee cream's official ice cream store API: {api_docs}
...
With the API Documentation for Icee cream's official API: {api_docs} and the specific user question: {question} in mind,
and given this API URL: {api_url} for querying, here is the response from Icee cream's API: {api_response}. 
...
as if Icee cream itself is providing this information.
Summary:
"""
